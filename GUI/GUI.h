...
public:
	...
	// Output Functions  ---------------------------
	//The current line argument controls whether we want to clear the bar and draw all over again 
	//or if we want to leave the bar as its and print in the line below
	void PrintMessage(string msg , int currentLine = 0) const; // prints a message in the status bar
	void PrintNumber(int num, int currentLine = 0) const;
